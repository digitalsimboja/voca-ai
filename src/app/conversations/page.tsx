        ...
        <Card>
          <CardContent className="p-3 sm:p-4">
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              <select className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-voca-cyan text-xs sm:text-sm">
          ...
          {[
            {
              ...
              value:
                statistics?.total_conversations || conversations.length,
              icon: MessageSquare,
              bg: "bg-voca-light",
            ...
            },
            {
              ...
              value:
                statistics?.active_conversations ||
             ...
             <Card key={i}>
               <CardContent className="p-4 sm:p-6">
                 <div className="flex items-center justify-between">
                   ...
                   <div
                     className={`w-8 h-8 sm:w-12 sm:h-12 ${stat.bg} rounded-lg flex items-center justify-center`}
                   >
                     <stat.icon
            ...
            {conversations.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">
                  Start by creating a conversation or wait for customer
                  interactions
                </p>
              </div>
            ) : (
                    ...
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <Badge
                            variant={
                              conversation.isActive ? "success" : "default"
                            }
                            size="sm"
                          >
                        ...
                        {/* Conversation Info - Compact Layout */}
