        ...
        <div className="flex items-center justify-between p-3 lg:p-4 border-b border-gray-200">
          {!collapsed && (
            <div className="flex items-center space-x-2 min-w-0">
              <div className="w-8 h-8 bg-voca-cyan rounded-lg flex items-center justify-center flex-shrink-0">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "bg-voca-light text-voca-dark border border-voca-light shadow-sm"
            ...
            >
              <item.icon className={cn(
                ...
                isActive ? "text-voca-cyan" : "text-gray-500 group-hover:text-gray-700"
              )} />
              {(mobile || !collapsed) && (
