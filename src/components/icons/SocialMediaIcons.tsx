...
// Email Icon with yellow styling
export const EmailIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <div className={`${className} text-yellow-600`}>
...
// SMS Icon with blue border styling
export const SMSIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <div className={`${className} text-purple-600 border-2 border-purple-200 rounded-lg p-0.5`}>
    <svg viewBox="0 0 24 24" fill="currentColor">
