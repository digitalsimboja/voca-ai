    ...
    <StepLayout>
        ...
        <div className="p-3 sm:p-4">
          <div className="grid grid-cols-1 gap-3 sm:gap-4">
            ...
            {/* Facebook */}
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-lg p-3 sm:p-4 hover:shadow-md transition-all duration-200">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
                <div className="flex items-center space-x-2">
                ...
                <div className="space-y-2 bg-white/60 rounded-md p-2 sm:p-3">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-2 py-1.5 border rounded-md focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 text-xs sm:text-sm ${
