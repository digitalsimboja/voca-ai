...
export default function ProfileStep({ 
  ...
  return (
    <StepLayout className="p-3 sm:p-4 max-w-lg mx-auto w-full">
        {/* Header */}
        <div className="bg-gradient-to-r from-voca-light to-voca-light p-3 sm:p-4 border-b border-gray-100">
          <div className="flex items-center space-x-2">
            <div className="bg-gradient-to-r from-voca-cyan to-voca-cyan p-1 sm:p-1.5 rounded-md">
        ...
        <div className="p-3 sm:p-4">
          <div className="space-y-3 sm:space-y-4">
            ...
            <div>
                       ...
                       <span className="w-1.5 h-1.5 bg-voca-cyan rounded-full mr-1.5 shrink-0"></span>
                       ...
                       <input
                         ...
                         className={`w-full px-3 py-2 pr-8 border rounded-md text-sm focus:ring-2 transition-all duration-200 ${
                           validationErrors.profile?.name 
                             ...
                             : "border-gray-200 focus:ring-voca-cyan/20 focus:border-voca-cyan"
                         }`}
                       />
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full px-3 py-2 pr-8 border border-gray-200 rounded-md text-sm focus:ring-2 focus:ring-voca-cyan/20 focus:border-voca-cyan transition-all duration-200 appearance-none bg-white"
                >
            ...
            {/* Pro Tip */}
            <div className="bg-gradient-to-r from-voca-light to-voca-light p-2 sm:p-3 rounded-md border border-voca-light">
              <div className="flex items-start space-x-2">
                <div className="bg-voca-cyan p-1 rounded-sm shrink-0">
                  <svg
